...
To further validate this model given the quantity of observations available, I fit a linear regression model using a Leave One Out Cross-Validation(LOOCV). This was performed by spliting the census dataset subset into 2 parts and training the model by leaving out one variable at a time. In this case, likelihood of cyberbullying was tested against family income levels, age, and state of residence.
