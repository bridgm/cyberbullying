...
```{r CyberbullyByState, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)
...
x = dfCPSComputerSupplement2019Cyberbullied$FamilyIncomeRange
y1 = dfCPSComputerSupplement2019Cyberbullied$CyberBullied

ggplot(dfCPSComputerSupplement, aes(FamilyIncomeRange, after_stat(density), colour = cut)) +
...
dfCPSComputerSupplement2019Cyberbullied <- filter(dfCPSComputerSupplement, CyberBulliedAnswer=="Yes", InterviewYear=="2019") 

x = dfCPSComputerSupplementCyberbullied$FamilyIncome
y1 = dfCPSComputerSupplementCyberbullied$CyberBulliedAnswer

# histogram
ggplot(dfCPSComputerSupplementCyberbullied, aes(x=reorder(x, FamilyIncome), stat="count", color=y1)) +
...
dfCPSComputerSupplement %>% count(FamilyIncome, FamilyIncomeRange, CyberBulliedAnswer="Yes")
...
```{r DemographicIndicators, include=FALSE}
