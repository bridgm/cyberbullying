...
total_bullied.hist<- ggplot(CyberBully_Summation, aes(x=x, y=y)) + 
  geom_bar(stat = "identity", color=themecolor1 )
total_bullied.hist
...
Gender_Bullied %>% 
  ...
  theme(
    ...
    plot.title = element_text(hjust = 0.5, size = 14)) +
      scale_color_manual(values=c("#999999", "#E69F00", "#DAF7A6"))+
    scale_fill_manual(values=c("#999999", "#E69F00", "#DAF7A6"))
...
objDependentVariable <- dfCPS$CyberBullied
